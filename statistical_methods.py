...
#plot_co2 fonk. df veya series olarak istediği için series e çevirelim
...
p = d = q = range(0, 4)
pdq = list(itertools.product(p, d, q)) #kombinasyonlarda gezecek
...
def arima_optimizer_aic(train, orders):
    ...
    for order in orders:
        try:
            ...
            print(f'ARIMA{order} başarısız: {e}')
            continue
